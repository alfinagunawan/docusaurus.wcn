...
Halaman Customer dapat dilihat pada **Gambar 2.8.1**
:::

<img src="/img/qc/masterdata/customer1.png" alt="Deskripsi gambar" class="center" />
<p style={{textAlign: 'center', fontSize: '0.8em'}}>
Gambar 2.8.1 Halaman Customer
</p>
...
1. **`Tekan tombol`** ***Add Customer*** dan pengguna akan diarahkan pada halaman penambahan Customer seperti pada **Gambar 2.8.2**.

<img src="/img/qc/masterdata/customer2.png" alt="Deskripsi gambar" class="center" />
<p style={{textAlign: 'center', fontSize: '0.8em'}}>
Gambar 2.8.2 Halaman Add Customer
</p>
...
|Address|Alamat yang terkait secara khusus dengan pelanggan tertentu.|Tidak
