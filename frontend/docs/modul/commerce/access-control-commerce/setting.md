...
- ***Format identitas pajak perusahaan***
- ***Pengaturan sistem pengiriman email otomatis (SMTP)***

Halaman menu Setting dapat dilihat pada **Gambar 9.1.1.**
:::

<img src="/img/commerce/access-control/setting1.png" alt="Deskripsi gambar" class="center" />
...
1. **`Tekan tombol`** ***Add Edit Setting*** dan pengguna akan diarahkan pada halaman penyuntingan setting seperti pada **Gambar 9.1.2.**

<img src="/img/commerce/access-control/setting2.png" alt="Deskripsi gambar" class="center" />
<p style={{textAlign: 'center', fontSize: '0.8em'}}>
Gambar 9.1.2 Halaman Edit Setting
</p>
