...
|ID|Kode unik untuk produk|Ya
|Description|Penjelasan singkat tentang produk.|Tidak
|Type|Jenis produk|Tidak
|Group Type|Klasifikasi apakah produk ini termasuk : ***Production*** – Produk yang terlibat dalam proses produksi. ***Non-Production*** – Produk yang tidak terlibat langsung (misalnya alat tulis, biaya).|Tidak
|Classification|Pilihan klasifikasi tambahan untuk produk, diambil dari menu Classification.|Tidak
...
|Purchase Price|Harga beli per satuan.|Tidak
|Purchase Currency|Mata uang untuk pembelian.|Tidak
|Sales UoM|Satuan penjualan.|Tidak
|Item Per Sales|Jumlah item per unit penjualan.|Tidak
|Sales Price|Harga jual per unit.|Tidak
|Sales Currency|Mata uang penjualan.|Tidak
