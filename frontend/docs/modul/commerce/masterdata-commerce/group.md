...
|--|--|--|
|Add|Menambah Group.|Tekan tombol Add Group.|
|Download|Mengunduh Group dalam format file .xls atau .csv.|Tekan tombol Download.|
|Upload|Mengunggah Group dari file dengan format .xlsx, .xls, atau .csv.|Tekan tombol Upload.|
...
|Edit|Menyunting Group.|Tekan tombol Edit pada kolom Action.|
|Delete|Menghapus Group.|Tekan tombol Delete pada kolom Action.|
|Multiple Delete|Menghapus beberapa Group sekaligus.|Pilih Group baris atau dengan mencentang kotak pada sebelah kiri. Kemudian tekan tombol Multiple  Delete (berwarna merah).|
...
|Fitur|Deskripsi|Cara Akses|
|--|--|--|
|Duplicate Group|Formulir Group akan terisi Otomatis berdasarkan data yang sudah terdaftar|Tekan tombol Duplicate Group|

|Isian|Deskripsi|Wajib Diisi|
|--|--|--|
|Type|Menentukan jenis grup yang akan dibuat, apakah untuk Customer, Supplier, atau lainnya.|Ya
