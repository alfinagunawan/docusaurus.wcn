...
|--|--|--|
|Add|Menambah mata uang.|Tekan tombol Add Currency.|
|Download|Mengunduh mata uang dalam format file .xls atau .csv.|Tekan tombol Download.|
|Upload|Mengunggah mata uang dari file dengan format .xlsx, .xls, atau .csv.|Tekan tombol Upload.|
...
|Edit|Menyunting mata uang.|Tekan tombol Edit pada kolom Action.|
|Delete|Menghapus mata uang.|Tekan tombol Delete pada kolom Action.|
|Multiple Delete|Menghapus beberapa mata uang sekaligus.|Pilih mata uang baris atau dengan mencentang kotak pada sebelah kiri. Kemudian tekan tombol Multiple  Delete (berwarna merah).|
...
|Fitur|Deskripsi|Cara Akses|
|--|--|--|
|Duplicate Currency|Formulir Currency akan terisi Otomatis berdasarkan data yang sudah terdaftar|Tekan tombol Duplicate Currency|
...
2. **`Isilah data penambahan Currency`** lalu tekan tombol ***Submit***.