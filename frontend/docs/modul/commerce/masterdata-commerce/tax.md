...
|--|--|--|
|Add|Menambah pajak.|Tekan tombol Add Tax.|
|Download|Mengunduh pajak dalam format file .xls atau .csv.|Tekan tombol Download.|
|Upload|Mengunggah pajak dari file dengan format .xlsx, .xls, atau .csv.|Tekan tombol Upload.|
...
|Edit|Menyunting pajak.|Tekan tombol Edit pada kolom Action.|
|Delete|Menghapus pajak.|Tekan tombol Delete pada kolom Action.|
|Multiple Delete|Menghapus beberapa pajak sekaligus.|Pilih pajak baris atau dengan mencentang kotak pada sebelah kiri. Kemudian tekan tombol Multiple  Delete (berwarna merah).|
...
|Fitur|Deskripsi|Cara Akses|
|--|--|--|
|Duplicate Tax|Formulir Tax akan terisi Otomatis berdasarkan data yang sudah terdaftar|Tekan tombol Duplicate Tax|

|Isian|Deskripsi|Wajib Diisi|
|--|--|--|
|Name|Nama lengkap dari pajak.|Ya
