...
:::note
**`Menu License digunakan untuk mengelola data kendaraan`** yang digunakan dalam proses operasional, seperti pengiriman barang, inspeksi keamanan, atau aktivitas logistik lainnya. Halaman menu Vehicle dapat dilihat pada **Gambar 2.4.1**.
:::

<img src="/img/masterdata/vehicle/vehicle 1.png" alt="Deskripsi gambar" class="center" />
<p style={{textAlign: 'center', fontSize: '0.8em'}}>
Gambar 2.4.1 Halaman Menu Vehicle
</p>
...
**`Berikut petunjuk dalam menambahkan Vehicle :`**

1. **`Tekan tombol`** ***Add Vehicle*** dan pengguna akan diarahkan pada halaman penambahan kendaraan seperti pada **Gambar 2.4.1.1**.

<img src="/img/masterdata/vehicle/vehicle 2.png" alt="Deskripsi gambar" class="center" />
<p style={{textAlign: 'center', fontSize: '0.8em'}}>
Gambar 2.4.1.1 Halaman Add Vehicle
</p>
...
|--|--|--|
|Vehicle Name|Nama kendaraan sebagai identitas internal. Biasanya mencerminkan jenis atau kode unit (contoh: "Truk Tangki 1" atau "Mobil Box A").|Ya
|License Plate|Nomor polisi kendaraan. Ini adalah identifikasi unik untuk setiap kendaraan. Contoh: B 1234 CD.|Ya
|Date Annual Vehicle Tax|Tanggal jatuh tempo pajak tahunan kendaraan.|Tidak
